...
<head>
    <meta charset="UTF-8">
    <title>Ace in the Hole MultiSport Weekend :: Courses</title>
...
<main>
    <img class="mb" src="../images/bicycles-bikes-sport-383.jpg" alt="Image of bikes">
    ...
    <h2>Upcoming Event: 23-24 March 2019</h2>
    <p>
    ...
    <h1>OLYMPIC Course</h1>
    <h3>SWIM – 1,500 meters </h3>
    <p id="baglicolor">
        Participants will make two counter-clockwise loops. Large buoys will mark the turn points. Kayakers will be positioned on the water to support the swimmers. Medical support will be present on the beach.
    </p>
    <h3>BIKE – 28mi </h3>
    ...
    <h1>The Splash n' Dash</h1>
    <p id="baglicolor">The Splash n' Dash is a kids event for kids ages 6 to 14. It is a 100 yard swim and a 50 meter dash. It is free if an adult registers or $25 if they do not.</p>
