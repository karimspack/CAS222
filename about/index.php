...
<main>
	...
	<h2>The Annual Ace in the Hole MultiSport Weekend </h2>
	...
	<h3>What to Bring</h3>
	<p>
		Watch the weather closely.  The show goes on no matter what the weather is doing.<br>
		...
		<div class="col span_6_of_12">
            <div>
				<img src="../images/swim.png" alt="Icon for swiming" title="Icon for swiming">
			</div>
        </div>
        <div class="col span_6_of_12">
            <div>
				<h3>Swim</h3>
				<p id="baglicolor">Wetsuits are optional for the swim but will provide buoyancy and warmth. However, many people opt for no wetsuit for a triathlon so no worries.  We will provide you with a swim cap, but you will want to bring your own goggles.</p>
			</div>
        </div>
		</section>
		<section class="section group">
        <div class="col span_6_of_12">
            <div id="imageicon">
				<img src="../images/bike.png" alt="Icon of a Bike" title="Icon of a Bike">
			</div>
        </div>
	    <div class="col span_6_of_12">
            <div>
				<h3>Bike</h3>
				<p id="bagcolor">A biking helmet is mandatory.  You will also receive 2 stickers in your package with your race number on them.  The small sticker should go on the front of your helmet.  The bigger sticker will wrap around your bike frame.  Road or mountain bikes are acceptable.  For safety reasons, be sure to have end-caps on the end of your handle-bars.</p>
			</div>
        </div>
		</section>
		<section class="section group">
	...
	<p>
		All packet pick up will occur at Why Worry Racing, 123 NW Everett, Portland OR.<br> Packet pick up hours: Thursday 8-5, Friday 9-noon.<br> No day of event packet pick up.
	</p>
